...
# Explanation:
# Animal is the parent class and contains the eat() method.
# Dog inherits from Animal, so Dog objects can use eat().
# Dog also defines its own bark() method.
# The dog object can therefore use methods from both classes.
